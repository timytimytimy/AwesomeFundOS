...
class AgentRuntimeIntegrationTests(unittest.TestCase):
    def test_context_pack_embeds_agent_card_and_skill_runtime_contract(self):
        ...
        self.assertIn("Procedure", context["skill_contract"]["sections"])
        self.assertIn("Quality Gates", context["skill_contract"]["sections"])
        ...
        self.assertTrue(context["skill_contract"]["procedure"])
        self.assertTrue(context["skill_contract"]["quality_gates"])
        self.assertTrue(any("Confirm the active agent identity" in item for item in context["skill_contract"]["procedure"]))
        self.assertTrue(any("Identity gate" in item for item in context["skill_contract"]["quality_gates"]))
        ...
        self.assertTrue(policy["policy_contract"])
        self.assertTrue(policy["context_contract"])
        ...
        self.assertIn("context_contract_loaded", policy["controls"])
        ...
        self.assertTrue(exec_policy["policy_contract"])
        self.assertTrue(exec_policy["context_contract"])
        ...
        self.assertIn("context_contract_loaded", exec_policy["controls"])
    ...
    def test_agent_output_uses_agent_card_and_skill_contract(self):
        ...
        self.assertIn("Procedure", output["agent_runtime"]["skill_sections"])
        self.assertIn("Quality Gates", output["agent_runtime"]["skill_sections"])
        self.assertIn("Harness Hooks", output["agent_runtime"]["skill_sections"])
        self.assertIn("skill_guardrails_applied", output)
        self.assertTrue(output["procedure_steps_executed"])
        self.assertTrue(output["quality_gates_checked"])
        self.assertTrue(output["quality_gate_checks"]["identity_gate"])
        self.assertTrue(output["quality_gate_checks"]["evidence_gate"])
        self.assertTrue(output["quality_gate_checks"]["source_boundary_gate"])
        self.assertTrue(output["quality_gate_checks"]["context_gate"])
        self.assertTrue(output["quality_gate_checks"]["safety_gate"])
        self.assertTrue(output["quality_gate_checks"]["evolution_gate"])
        ...
        self.assertTrue(policy["agent_policy_contract"])
        self.assertTrue(policy["agent_context_contract"])
        ...
        self.assertTrue(policy["skill_policy_contract"])
        self.assertTrue(policy["skill_context_contract"])
