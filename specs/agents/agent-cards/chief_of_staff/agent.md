...
- contract_id: `chief_of_staff_agent_policy_contract_v1`.
...
- memory_namespace: `memory/agents/chief_of_staff`.
- thread_manifest: `memory/agents/chief_of_staff/thread.yaml`.
...
- allowed_tool_scope: use only tools assigned in default roster and `specs/agents/tool-policies/chief_of_staff.yaml`.
