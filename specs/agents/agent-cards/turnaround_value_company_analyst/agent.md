...
- Persistent thread manifest: `memory/agents/turnaround_value_company_analyst/thread.yaml`.
- Append-only thread event log: `memory/agents/turnaround_value_company_analyst/thread-events.jsonl`.
