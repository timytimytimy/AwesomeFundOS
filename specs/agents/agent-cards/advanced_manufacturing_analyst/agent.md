...
- Persistent thread manifest: `memory/agents/advanced_manufacturing_analyst/thread.yaml`.
- Append-only thread event log: `memory/agents/advanced_manufacturing_analyst/thread-events.jsonl`.
