...
- Persistent thread manifest: `memory/agents/position_trend_trader/thread.yaml`.
- Append-only thread event log: `memory/agents/position_trend_trader/thread-events.jsonl`.
...
- Long-term namespace: `memory/agents/position_trend_trader`.
- Run-specific outputs live under `runs/<run_id>/agent_work/position_trend_trader.*`.
- Reflections live under `runs/<run_id>/reflections/position_trend_trader.reflection.yaml`.
