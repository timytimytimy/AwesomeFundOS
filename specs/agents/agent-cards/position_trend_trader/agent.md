...
- contract_id: `position_trend_trader_agent_policy_contract_v1`.
...
- memory_namespace: `memory/agents/position_trend_trader`.
- thread_manifest: `memory/agents/position_trend_trader/thread.yaml`.
...
- allowed_tool_scope: use only tools assigned in default roster and `specs/agents/tool-policies/position_trend_trader.yaml`.
