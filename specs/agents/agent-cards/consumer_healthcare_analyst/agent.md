...
- contract_id: `consumer_healthcare_analyst_agent_policy_contract_v1`.
...
- memory_namespace: `memory/agents/consumer_healthcare_analyst`.
- thread_manifest: `memory/agents/consumer_healthcare_analyst/thread.yaml`.
...
- allowed_tool_scope: use only tools assigned in default roster and `specs/agents/tool-policies/consumer_healthcare_analyst.yaml`.
