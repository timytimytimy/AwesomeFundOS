...
- Persistent thread manifest: `memory/agents/consumer_healthcare_analyst/thread.yaml`.
- Append-only thread event log: `memory/agents/consumer_healthcare_analyst/thread-events.jsonl`.
