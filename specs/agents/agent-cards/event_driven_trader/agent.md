...
- Persistent thread manifest: `memory/agents/event_driven_trader/thread.yaml`.
- Append-only thread event log: `memory/agents/event_driven_trader/thread-events.jsonl`.
