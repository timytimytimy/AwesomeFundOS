...
- Persistent thread manifest: `memory/agents/defensive_execution_trader/thread.yaml`.
- Append-only thread event log: `memory/agents/defensive_execution_trader/thread-events.jsonl`.
