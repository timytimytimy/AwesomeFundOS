...
- contract_id: `swing_trader_agent_policy_contract_v1`.
...
- memory_namespace: `memory/agents/swing_trader`.
- thread_manifest: `memory/agents/swing_trader/thread.yaml`.
...
- allowed_tool_scope: use only tools assigned in default roster and `specs/agents/tool-policies/swing_trader.yaml`.
