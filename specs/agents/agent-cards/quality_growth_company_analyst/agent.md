...
- contract_id: `quality_growth_company_analyst_agent_policy_contract_v1`.
...
- memory_namespace: `memory/agents/quality_growth_company_analyst`.
- thread_manifest: `memory/agents/quality_growth_company_analyst/thread.yaml`.
...
- allowed_tool_scope: use only tools assigned in default roster and `specs/agents/tool-policies/quality_growth_company_analyst.yaml`.
