...
def summarize_context_management(agent_harness: dict[str, Any]) -> dict[str, Any]:
    ...
    if not qualities:
        return {
            ...
            "role_context_contract_present": 0,
            "required_context_dimensions_covered": 0,
            "forbidden_drop_list_respected": 0,
            "retained_omitted_dimensions_traced": 0,
